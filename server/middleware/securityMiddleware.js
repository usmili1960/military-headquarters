      ...
      return helmet({
        contentSecurityPolicy: {
          directives: {
            ...
            connectSrc: ["'self'", "http://localhost:*", "https://localhost:*", "ws://localhost:*", "wss://localhost:*", "https://*.smartsuppchat.com", "wss://*.smartsuppchat.com", "https://*.smartsupp.com", "wss://*.smartsupp.com", "https://*.smartsuppcdn.com", "wss://*.smartsuppcdn.com"],
            objectSrc: ["'none'"],
            mediaSrc: ["'self'"],
      ...
      return helmet({
        contentSecurityPolicy: {
          directives: {
            ...
            connectSrc: ["'self'", "https://*.smartsuppchat.com", "wss://*.smartsuppchat.com", "https://*.smartsupp.com", "wss://*.smartsupp.com", "https://*.smartsuppcdn.com", "wss://*.smartsuppcdn.com"],
            objectSrc: ["'none'"],
            mediaSrc: ["'self'"],
            frameSrc: ["'self'", "https://*.smartsuppchat.com", "https://*.smartsupp.com", "https://*.smartsuppcdn.com"],
          },
