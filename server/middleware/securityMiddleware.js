    ...
    if (isDevelopment) {
      ...
      return helmet({
        contentSecurityPolicy: {
          directives: {
            defaultSrc: ["'self'"],
            styleSrc: ["'self'", "'unsafe-inline'", "https://fonts.googleapis.com", "https://cdnjs.cloudflare.com", "https://*.smartsuppcdn.com", "https://*.smartsuppchat.com"],
            fontSrc: ["'self'", "https://fonts.gstatic.com", "https://cdnjs.cloudflare.com", "https://*.smartsuppcdn.com", "https://*.smartsuppchat.com"],
            imgSrc: ["'self'", "data:", "https:", "http:", "https://*.smartsuppcdn.com", "https://*.smartsuppchat.com"],
            scriptSrc: ["'self'", "'unsafe-inline'", "'unsafe-eval'", "https://www.smartsuppchat.com", "https://*.smartsuppchat.com", "https://*.smartsuppcdn.com"],
            connectSrc: ["'self'", "http://localhost:*", "https://localhost:*", "ws://localhost:*", "wss://localhost:*", "https://*.smartsuppchat.com", "wss://*.smartsuppchat.com", "https://*.smartsupp.com", "wss://*.smartsupp.com", "https://*.smartsuppcdn.com", "wss://*.smartsuppcdn.com", "https://cdn.jsdelivr.net"],
            objectSrc: ["'none'"],
            mediaSrc: ["'self'", "https://*.smartsuppcdn.com", "https://*.smartsuppchat.com", "blob:", "data:"],
      ...
      return helmet({
        contentSecurityPolicy: {
          directives: {
            ...
            styleSrc: ["'self'", "'unsafe-inline'", "https://fonts.googleapis.com", "https://cdnjs.cloudflare.com", "https://*.smartsuppcdn.com", "https://*.smartsuppchat.com"],
            fontSrc: ["'self'", "https://fonts.gstatic.com", "https://cdnjs.cloudflare.com", "https://*.smartsuppcdn.com", "https://*.smartsuppchat.com"],
            imgSrc: ["'self'", "data:", "https:", "https://*.smartsuppcdn.com", "https://*.smartsuppchat.com"],
            scriptSrc: ["'self'", "'unsafe-inline'", "https://www.smartsuppchat.com", "https://*.smartsuppchat.com", "https://*.smartsuppcdn.com"],
            connectSrc: ["'self'", "https://*.smartsuppchat.com", "wss://*.smartsuppchat.com", "https://*.smartsupp.com", "wss://*.smartsupp.com", "https://*.smartsuppcdn.com", "wss://*.smartsuppcdn.com", "https://cdn.jsdelivr.net"],
            objectSrc: ["'none'"],
            mediaSrc: ["'self'", "https://*.smartsuppcdn.com", "https://*.smartsuppchat.com", "blob:", "data:"],
            frameSrc: ["'self'", "https://*.smartsuppchat.com", "https://*.smartsupp.com", "https://*.smartsuppcdn.com"],
          },
